    ...
    <>
        <div className='pt-10'>
         ...
         <div className='flex flex-col lg:flex-row justify-between m-auto p-8'>
            <div className='lg:w-[50%] object-cover my-auto'><img src="https://images.unsplash.com/photo-1495546968767-f0573cca821e?q=80&w=1031&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className='rounded-full'/></div>
         <div className='lg:w-[50%] list-disc list-inside p-2 md:font-semibold my-auto text-justify text-2xl'>
